...
export const en = {
  ...
  acuity: {
    ...
    calibrateLead:
      'Stand a card upright on the blue box. It will hang past the bottom of the phone, which is fine. Press plus until blue shows on both sides, then minus until it goes.',
    narrower: 'Narrower',
    wider: 'Wider',
